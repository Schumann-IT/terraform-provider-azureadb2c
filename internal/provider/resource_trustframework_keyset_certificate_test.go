		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("azureadb2c_trustframework_keyset_certificate.test", "keyset_id", "B2C_1A_TestContainer"),
					resource.TestCheckResourceAttr("azureadb2c_trustframework_keyset_certificate.test", "data.kty", "RSA"),
				),
			},
		},
	})
